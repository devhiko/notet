...
import { Card, CardContent, Typography, Checkbox, CardActions, Button } from '@mui/material'
  ...
  return (
    ...
    >
      ...
      <CardActions className={styles.actions}>
        ...
        <Button size="small">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" className="bi bi-trash" viewBox="0 0 16 16">
